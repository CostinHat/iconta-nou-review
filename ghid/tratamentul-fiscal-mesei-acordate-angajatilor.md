...
description: Masa acordată angajaților poate însemna, fiscal, două lucruri diferite — tichete de masă sau indemnizație de hrană în bani — iar cele două au reguli separate care nu se aplică deodată aceleiași forme de acordare.
...
Înainte de a stabili tratamentul fiscal, trebuie clarificat sub ce formă se acordă efectiv masa: ca **tichet de masă** (bilet de valoare, cu regim propriu) sau ca **indemnizație de hrană în bani** (sumă acordată direct prin statul de plată). Sunt două beneficii cu reguli fiscale distincte, care nu se cumulează pe aceleași zile.
...
Pentru **indemnizația de hrană acordată în bani** — o formă distinctă de beneficiu, prevăzută separat în Codul fiscal la art. 76 alin. (4^1) lit. b) — regulile de calcul al plafonului neimpozabil sunt diferite de cele ale tichetelor de masă, iar textul de lege precizează explicit că nu se aplică angajaților care beneficiază deja de tichete de masă. Cele două forme sunt, deci, alternative reciproc excluzive pentru aceeași categorie de beneficiu, nu cumulative.

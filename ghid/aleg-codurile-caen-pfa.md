---
title: "Cum aleg codurile CAEN pentru un PFA?"
description: "Nu am găsit, în sursele legale verificate, actul normativ care reglementează explicit înregistrarea și alegerea codurilor CAEN la constituirea unei PFA — ghidul redirecționează onest spre această limitare."
...
- Se aleg coduri CAEN „pe ghicite", după denumirea activității, fără verificarea corespondenței exacte din nomenclatorul CAEN în vigoare — codul greșit poate bloca ulterior emiterea de facturi sau raportarea corectă a veniturilor.
- Se presupune că orice cod secundar declarat la înființare poate fi folosit fără nicio altă formalitate, indiferent de activitate — unele coduri CAEN presupun autorizări sau avize suplimentare, distincte de simpla înregistrare la Registrul Comerțului.
- Se lasă neactualizat codul CAEN principal atunci când activitatea reală a PFA se schimbă semnificativ — nealinierea între codul înregistrat și activitatea desfășurată efectiv poate ridica întrebări la un control.

## Ce face iConta.eu

iConta.eu permite introducerea codului CAEN al firmei/PFA în profilul acesteia, folosit apoi în declarațiile care îl cer (de exemplu D112, D101). Aplicația **nu alege și nu validează** codurile CAEN la înființare — acesta e un pas administrativ care are loc înainte de utilizarea aplicației, la Registrul Comerțului.

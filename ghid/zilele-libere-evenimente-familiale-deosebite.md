...
Alin. (2) al aceluiași articol trimite explicit determinarea concretă în afara Codului muncii: "Evenimentele familiale deosebite și numărul zilelor libere plătite sunt stabilite prin lege, prin contractul colectiv de muncă aplicabil sau prin regulamentul intern."

Practic, Codul muncii **nu enumeră** el însuși evenimentele (căsătorie, naștere copil, deces rudă etc.) și nici numărul de zile — acestea sunt de căutat, pentru fiecare angajator, în:
1. o lege specială care ar reglementa distinct acest drept pentru un anumit sector (dacă există pentru sectorul respectiv);
2. contractul colectiv de muncă aplicabil la nivel de unitate/sector, dacă există unul negociat;
3. regulamentul intern al angajatorului, dacă nu există CCM aplicabil sau CCM nu tratează subiectul.

Nu mai există, din 2011, un contract colectiv de muncă unic la nivel național care să impună o listă standard tuturor angajatorilor — de aceea, pentru fiecare firmă, sursa concretă a listei de evenimente și a numărului de zile e regulamentul intern propriu sau CCM-ul specific aplicabil, nu o listă legală națională unitară.

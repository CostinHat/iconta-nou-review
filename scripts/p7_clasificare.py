...
TEXTUL CANONIC: `PLAN_HARDENING.md:733-803`. Cele trei verificări mecanice, verbatim (l. 749-751):
...
REGULI = {
    "D1_SQL_IN_RUTA": Regula(
        AR, "PLAN_HARDENING.md:798 — «ruta nu conține SQL»",
    ...
    "D2_MOTOR_FISCAL_CU_DB": Regula(
        AR, "PLAN_HARDENING.md:797 — «un motor fiscal nu importă `db`»",
    ...
    "D3_HTTP_SUB_HTTP_IN_MODUL_DE_RUTE": Regula(
        ABD, "PLAN_HARDENING.md:791 — «HTTP — validare de formă, AUTENTIFICARE, traducerea "
             "erorilor în coduri»",
    ...
    "D4_STRAT_MIXT": Regula(
        AR, "PLAN_HARDENING.md:790-794 — cele patru straturi, fiecare cu sarcina lui",

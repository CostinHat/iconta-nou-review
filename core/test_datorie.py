...
@pytest.mark.xfail(strict=True, reason="DATORIE FISCALA 31.07.2026: contributiile pe indemnizatia de concediu medical se calculeaza in DOUA locuri care DEVIAZA (doua surse de adevar): salarizare.taxe_cm (CAS=0, CASS doar 01/07/10) - stocat la salvare, alimenteaza fluturasul/statul; d112 ramura CM (CAS=25% pe bazac+cm_base, CASS uniform pe tot) - alimenteaza D112. Verificat la sursa: CM1 CAS pe CM = 25% UNIFORM pe TOATE codurile (temei CF art.139(1)(o)+140, NU art.144; ghid ANAF Sectiunea A/B primar - maternitatea 08/ingrijire 09 NU sunt exceptate de CAS) -> taxe_cm cas=0 GRESIT, d112 corect pe CAS; CM2 CASS doar 01/07/10 (OUG 34/2024) dar d112 aplica UNIFORM -> d112 GRESIT pe CASS; CM4 plafon 12 sm (art.10(1)) in _cm_media6 dar nu in calcul_cm. (CM3 carantina 07=100% deja FIXATA in 667f46d.) Fixul = UNIFICARE intr-o functie canonica (fluturas + D112): CAS 25% uniform + CASS doar 01/07/10 + plafon 12 sm, DUK-valid. Tier-1 just.ro pt art.139(1)(o) ramane pending (secundar + ANAF primar). Se inchide cand e unificat si consemnat in DECIZII.md.")

...
# INCHISA 23.08.2026: analizatorul are acum fixturi known-good/known-bad
# (`core/test_verificator_izolare.py`, 8 fixturi, RED-proof pe bug-ul din 31.07).
# Marcajul xfail a fost SCOS - datoria e platita, nu amanata.

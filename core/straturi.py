...
CELE PATRU STRATURI sunt cele din `PLAN_HARDENING.md:804-808`, niciunul în plus:
...
REGISTRU = (
    D("core/amef_import.py", FISCAL_ENGINE, None,
      ...
      "PLAN_HARDENING.md:807 — motorul fiscal primeste date si intoarce rezultat"),
    ...
    D("core/efactura_send.py", FISCAL_ENGINE, None,
      ...
      "PLAN_HARDENING.md:811 — un motor fiscal nu importa `db`"),
    D("core/efactura_trimitere.py", USE_CASE, None,
      ...
      "PLAN_HARDENING.md:806 — use-case-ul detine tranzactia si orchestreaza"),
    ...
    D("core/spv_rute.py", HTTP, None,
      ...
      "PLAN_HARDENING.md:805 — stratul HTTP e acolo unde sunt rutele"),
    ...
    D("core/repo_admin.py", REPOSITORY, None,
      ...
      "PLAN_HARDENING.md:808 — repository-ul e singurul care stie SQL si scheme"),

...
CELE PATRU STRATURI sunt cele din `PLAN_HARDENING.md:790-794`, niciunul în plus:
...
REGISTRU = (
    D("core/amef_import.py", FISCAL_ENGINE, None,
      ...
      "PLAN_HARDENING.md:793 — motorul fiscal primeste date si intoarce rezultat"),
    ...
    D("core/efactura_send.py", FISCAL_ENGINE, None,
      ...
      "PLAN_HARDENING.md:797 — un motor fiscal nu importa `db`"),
    D("core/efactura_trimitere.py", USE_CASE, None,
      ...
      "PLAN_HARDENING.md:792 — use-case-ul detine tranzactia si orchestreaza"),
    ...
    D("core/spv_rute.py", HTTP, None,
      ...
      "PLAN_HARDENING.md:791 — stratul HTTP e acolo unde sunt rutele"),
    ...
    D("core/repo_admin.py", REPOSITORY, None,
      ...
      "PLAN_HARDENING.md:794 — repository-ul e singurul care stie SQL si scheme"),

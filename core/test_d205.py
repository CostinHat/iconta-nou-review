...
def test_impozit_dividend_period_aware_cf_art97():
    ...
    # 2026: 16% (Legea 141/2025). 2025: 10% (OUG 156/2024). 2024: 8% (OG 16/2022). Proba de valoare pe 50000 div:
    # [CORECTAT 16.08.2026] 2025 era asertat gresit 8% (cimenta bugul din registru); sursa OUG 156/2024 + struct D205 = 10%.
    assert cota("impozit_dividend", date(2026, 12, 31))[0] == Decimal("0.16")   # CF art.97 / Legea 141/2025
    assert cota("impozit_dividend", date(2025, 12, 31))[0] == Decimal("0.10")   # OUG 156/2024, de la 01.01.2025
    assert cota("impozit_dividend", date(2024, 12, 31))[0] == Decimal("0.08")   # OG 16/2022 (2023-2024)

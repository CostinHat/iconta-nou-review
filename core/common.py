...
COTE = {
    ...
    # v. core/lichidare._VARIANTE_COTA_LICHIDARE; NU se mai foloseste cota dividendelor pentru lichidare.) Cote istorice VERIFICATE
    # 5% (2016-2022), 8% (2023-2024, OG 16/2022), 10% (2025, OUG 156/2024), 16% (de la 01.01.2026, Legea 141/2025).
    # Se aplica dupa data DISTRIBUIRII. [CORECTAT 16.08.2026] Anterior lipsea 2025->10% (registrul returna 8% pt 2025
    # = sub-declarare 20%); nota/comentariul care ziceau "10% e GRESIT (e cota art.78)" au confundat DATA - peticul
    ...
    "plafon_intrastat": [
        (date(2026, 1, 1), Decimal("1000000"), Temei("Ordin", 1604, 2025, art="1", data_in="2026-02-01", verificat_la="2026-09-01", de_cine="Code (R110)", nivel_sursa="MO", url="anaf_surse/ordin_1604_2025_intrastat_mo.txt", text_citat="art.1: Se aproba urmatoarele praguri valorice Intrastat pentru colectarea informatiilor statistice de comert intra-UE cu bunuri pentru anul de referinta 2026: 1.000.000 lei pentru expedieri de bunuri si, respectiv, 1.000.000 lei pentru introduceri de bunuri", lant_acte="ADUS 01.09.2026 DE LA EMITENT, nu de pe portal: INS isi publica ordinul pe portalul propriu Intrastat (intrastat.ro/doc/OPINS_PRAGURI_1604_2026.pdf), ca scan al paginii din MO Partea I nr. 1022/5.XI.2025. Documentul se autentifica prin CONTINUT (antet MO + numar + semnatar + data), nu prin gazda: adresa e HTTP, iar insse.ro serveste un lant de certificate incomplet (openssl `num=21 unable to verify the first certificate`, si cu magazinul certifi). DOUA DATE, amandoua adevarate: art. 6 spune ca ordinul INTRA IN VIGOARE la 01.02.2026 (de-aia data_in), iar art. 1 aproba pragul pentru ANUL DE REFERINTA 2026, aplicat la cumulatul de la 01.01.2026 (art. 3) — care e cheia din registru. Pentru ianuarie 2026 actul in vigoare era Ordinul INS 2353/2024 (MO 1101/04.11.2024), abrogat de art. 5 la 01.02.2026 si NEADUS: R112. Pagina de portal (ordin_1604_2025_intrastat.html) ramane in corpus ca PROBA ca portalul nu poarta textul.")),
    ],
    "plafon_sold_casa": [
    ...
    "facilitate_salariu_minim": [
        ...
        (date(2025, 1, 1), Decimal("300"), Temei("OUG", 156, 2024, art="LXVI", data_in="2025-01-01", verificat_la="2026-08-09", de_cine="Code/Costin", nivel_sursa="MO", url="anaf_surse/oug_156_2024.pdf", text_citat="art.LXVI alin.(1): suma de 300 lei/luna, reprezentand venituri din salarii, nu se cuprinde in baza lunara de calcul al contributiilor sociale obligatorii (venit brut <= 4.300 lei); OUG 115/2023 citata anterior NU contine valoarea")),
    ],

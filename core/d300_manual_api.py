...
ETICHETE = {
    ...
    "R5": "Achiziții intracomunitare de bunuri pentru care cumpărătorul este obligat la plata TVA (taxare inversă)",
    "R6": "Regularizări privind achizițiile intracomunitare de bunuri pentru care cumpărătorul este obligat la plata TVA (taxare inversă)",
    "R7": "Achiziții de bunuri, altele decât cele de la rd. 5 și 6, și achiziții de servicii pentru care beneficiarul din România este obligat la plata TVA (taxare inversă)",
    "R8": "Regularizări privind achizițiile de servicii intracomunitare pentru care beneficiarul este obligat la plata TVA (taxare inversă)",
    "R12": "Achiziții de bunuri și servicii supuse măsurilor de simplificare pentru care beneficiarul este obligat la plata TVA (taxare inversă)",
    ...
    # --- DEDUCTIBILĂ ---
    "R18": "Achiziții intracomunitare de bunuri pentru care cumpărătorul este obligat la plata TVA (taxare inversă) — deductibil",
    "R19": "Regularizări privind achizițiile intracomunitare de bunuri pentru care cumpărătorul este obligat la plata TVA (taxare inversă)",
    "R20": "Achiziții de bunuri, altele decât cele de la rd. 20 și 21, și achiziții de servicii pentru care beneficiarul din România este obligat la plata TVA (taxare inversă) — deductibil",
    "R21": "Regularizări privind achizițiile de servicii intracomunitare pentru care beneficiarul din România este obligat la plata TVA (taxare inversă)",
    "R23": "Achiziții de bunuri și servicii, taxabile cu cota de 11% (deductibil)",
    "R25": "Achiziții de bunuri și servicii supuse măsurilor de simplificare pentru care beneficiarul este obligat la plata TVA (taxare inversă) — deductibil",

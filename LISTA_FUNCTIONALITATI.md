...
| 431 | Ecranul `fa-bilant` — 1 rute chemate: `/tenants/{}/categorie-marime` | `static/js/ecrane/firme.js::ecranBilant()` | interacțiune de ecran (atribuire pe funcție) | nu |neprobat — parcurs 04.09.2026 (lot 11), 1 câmp de filtru, niciun buton de salvare: n-are ce refuza|
...
| 441 | Ecranul `fa-fisacont` — 1 rute chemate: `/tenants/{}/fisa-cont` | `static/js/ecrane/firme.js::ecranFisaCont()` | interacțiune de ecran (atribuire pe funcție) | nu |neprobat — parcurs 04.09.2026 (lot 11), 1 câmp de filtru (contul), niciun buton de salvare|
...
| 445 | Ecranul `fa-marja` — 1 rute chemate: `/tenants/{}/jurnal-marja` | `static/js/ecrane/firme.js::ecranJurnalMarja()` | interacțiune de ecran (atribuire pe funcție) | nu |neprobat — parcurs 04.09.2026 (lot 11), 1 câmp de filtru, niciun buton de salvare|
...
| 447 | Ecranul `fa-operatiuni` — 0 rute chemate | `static/js/ecrane/operatiuni_ecran.js::ecranOperatiuni()` | interacțiune de ecran (atribuire pe funcție) | ? |neprobat — parcurs 04.09.2026 (lot 11), `campuri=0`|
...
| 451 | Ecranul `fa-regfiscal` — 1 rute chemate: `/tenants/{}/registru-evidenta-fiscala` | `static/js/ecrane/firme.js::ecranRegistruFiscal()` | interacțiune de ecran (atribuire pe funcție) | nu |neprobat — parcurs 04.09.2026 (lot 11), 1 câmp de filtru, niciun buton de salvare|
| 452 | Ecranul `fa-reginventar` — 2 rute chemate: `/tenants/{}/registru-inventar`, `/tenants/{}/registru-inventar/propunere` | `static/js/ecrane/firme.js::ecranRegistruInventar()` | interacțiune de ecran (atribuire pe funcție) | nu |neprobat — parcurs 04.09.2026 (lot 11), 1 câmp de filtru, niciun buton de salvare|
...
| 454 | Ecranul `fa-registre321` — 1 rute chemate: `/tenants/{}/registre-art321/{}` | `static/js/ecrane/firme.js::ecranRegistre321()` | interacțiune de ecran (atribuire pe funcție) | nu |neprobat — parcurs 04.09.2026 (lot 11), 13 câmpuri de filtru, niciun buton de salvare|
| 455 | Ecranul `fa-rip` — 8 rute chemate: `/tenants/{}/rip/d212/{}`, `/tenants/{}/rip/import-banca`, `/tenants/{}/rip/import-casa`, `/tenants/{}/rip/inventar/{}`, `/tenants/{}/rip/operatiuni`, `/tenants/{}/rip/operatiuni/{}`, `/tenants/{}/rip/operatiuni/{}/valideaza`, `/tenants/{}/rip/registru` | `static/js/ecrane/rip_ecran.js::ecranRip()` | interacțiune de ecran (atribuire pe funcție) | nu |neprobat — **cardul `#fa-rip` NU se randează pe firma campaniei** (`Comert Micro TVA SRL` e SRL; RIP e al partidei simple). Sonda a raportat navigare eșuată, nu „fără defect". Se probează în lotul 12, pe o firmă de partidă simplă (`DECIZII.md` 31)|
...
| 457 | Ecranul `fa-solicitari` — 0 rute chemate | `static/js/ecrane/firme.js::ecranSolicitariCabinet()` | interacțiune de ecran (atribuire pe funcție) | ? |neprobat — parcurs 04.09.2026 (lot 11), 1 câmp de filtru, niciun buton de salvare|

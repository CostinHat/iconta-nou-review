...
| **probate** | **317** (loturile 1–8 · lotul 9 = cele 72 de rute rămase · lotul 10 = 17 ecrane · lotul 11 = 6 · **lotul 12 = 12**, minus **5** mutate înapoi la `neprobat`) |
| **RĂMASE DE PROBAT** | **47** — 42 de ECRANE + **5 rute** pe care lotul 9 le-a marcat „fără defect” pe temeiul unui `403` de ROL, deci n-au ajuns la verificările lor proprii (`DECIZII.md` 32; se reprobează în lotul 14). Niciunul nu mai e „neatins": fiecare rând poartă motivul lui — fără câmp în DOM (afișare pură), formular la doi pași de deschizător, sau buton care iese din aplicație |

...
- **ultima rescriere**: **2026-08-26**, *a cincea din ziua asta*
- **pe commit**: `71d5b9a`
...
1. **`TRASEE_VERIFICARI.md` — îl completează Costin.** 192 de locuri, **0 scrise**. Până se scriu,
   ...
   **Loturile 1–5 sunt SCRISE** (150 de locuri completate, **42 rămase**). **Lotul 6 e dat**,
...
- **Nu ținti o mutație pe orice linie din funcția pe care o probezi.** Poate pica alt test, din
  alt motiv, iar atunci proba confirmă altceva. Instanța: poarta `INSERT|UPDATE|DELETE` se

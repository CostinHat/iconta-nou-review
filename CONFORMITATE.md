...
- **pasul curent**: **FAZA 2 — TEMEIURILE.** Toate interdicțiile măsurabile sunt măsurate. La **50**, domeniul s-a dovedit **17 acte, nu 9** (garda id-urilor a corectat numitorul la prima rulare), **toate au acum id de portal scris** — `anaf_surse/PORTAL_IDS.json`, ceea ce închide lipsa *0 din 529* — și **4 perechi act-articol sunt verificate la sursă, toate în vigoare**. Blocajul rămas e unul singur și e numit: forma consolidată a Codului fiscal se încarcă prin JS, de la un punct negăsit. Urmează, în ordinea decisă: **triajul** e pregătit; deciziile marcate acolo sunt ale lui Costin.
...
- **măsurat la**: 2026-08-23
- **pe commit**: `d115f28`
- **cifra**: **0 articole abrogate sau modificate fără succesor, din 4 perechi act-articol verificate la sursă** — plafon inferior, fiindcă domeniul verificat e o parte. **Domeniul REAL e 17 acte, nu 9**: prima măsurătoare număra doar actele citate **cu articol**; registrul mai citează **8 fără** — HG-urile de salariu minim, ordinele de plafon, Legea 70/2015. **Garda scrisă pentru id-urile de portal a corectat numitorul la prima ei rulare**
- **instanțe**: **niciuna.** Verificate la sursă, toate în vigoare: **OUG 89/2025 art. III** (fără marcaj) · **OUG 156/2024 art. LXVI** (modificat 10-01-2025, dar printr-o **RECTIFICARE de sintagmă** — *hotărâre a Guvernului* înlocuită — nu de valoare) · **Legea 141/2025 art. 291** (fără marcaj, iar textul confirmă verbatim *nivelul acesteia este 21%* și *Cota redusă de 11%*) · **Legea 201/2025 art. I** (fără marcaj).
...
- **calibrare**: cazul cunoscut a fost **găsit** în ambele direcții — instrumentul vede marcajul acolo unde este (OUG 89/2025 art. XXXVI, modificat 16-08-2026) și **nu-l atribuie unde nu e** (art. III, care poartă cele trei valori). Fără a doua jumătate, orice act modificat ar fi semnalat toate articolele lui. **Iar valorile s-au confruntat verbatim cu textul de azi** — 300/200 lei și 4.300/4.600 lei, cu perioadele exacte
- **ce nu vede**: **un singur blocaj rămas, și e numit:** forma consolidată a **Codului fiscal** nu e accesibilă prin pagina de detalii — **4.392 de caractere, 0 titluri de articol** — iar textul se încarcă prin JS de la un punct negăsit încă (încercate: `DetaliiDocumentAfis`, `isFormaDeBaza=False`, `FormaPrintabila`). Instrumentul **refuză** corect să răspundă acolo, în loc să spună NEGĂSIT. · Verifică dacă articolul e **modificat**, nu dacă modificarea **atinge valoarea** — aici confruntarea cu textul s-a făcut de om. · **Ambiguitate nerezolvată, scrisă ca atare:** `Ordin 484/2025` are **două forme** în portal (11/02 și 18/03); care poartă valoarea nu s-a citit, deci fișierul păstrează ambii candidați cu motivul, iar garda acceptă asta — dar **nu acceptă o alegere fără motiv**

...
- **decizii care blochează**: **una — R33, DESCHISĂ**, dar întrebarea ei s-a schimbat azi: jumătatea de **prag 1** (semnalul notă-vs-D112) e decisă, aplicată și probată pe procesul viu. Ce rămâne e **prag 2**: `echilibru_perioada` e a doua implementare a unei verificări care există deja legată — nu cod nelegat, ci **logică paralelă**, iar care dintre cele două rămâne e o alegere. **Decizie cerută.**

...
- **felul**: VERIFICARE
- **cine deblochează**: DECIZIE
- **unde intră**: E3 · interdicțiile 1 și 14 · **PRAG 1** *(ridicat de la prag 2 pe 23.08, vezi mai jos)*
- **reluări**: 0
- **stare**: DESCHISĂ
...
- **Ce NU s-a făcut, și de ce se spune:** reparația **nu a început în aceeași tură**, spre deosebire de R22. Motivul e că forma ei nu e determinată — cele două variante de mai sus au acoperiri diferite, iar cea ieftină ar arăta ca una completă. **Un prag 1 nereparat în aceeași tură e o abatere de la propria regulă**, deci se scrie ca atare, nu se ascunde: prima muncă din tura următoare, înaintea pragului 3.

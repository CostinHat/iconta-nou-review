...
- **cele șase reale**: `urme-portal` · `d406-active` · `d406-stocuri` · `jurnal-marja` · `s1003-xml` · `s1005-xml`. Două observații pe ele: `s1003-xml`/`s1005-xml` fac pereche cu `s1003-valideaza`/`s1005-valideaza` din jumătatea de scriere — deci **o funcționalitate întreagă are rute și niciun ecran**; iar `urme-portal` e a mea, de ieri, și e chiar cea care lasă punctul (3) din R62 nesatisfăcut.

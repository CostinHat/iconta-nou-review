...
- **ce NU face nici acum**: declararea e **de mână**, nu derivată. Gardul verifică marcajul, `_BASELINE` verifică mulțimea — dar cele două liste se țin sincronizate de om. O cale de declarare *mecanică* (baseline-ul citit din marcaje) e posibilă și n-a fost cerută.
...
- **condiția de deblocare**: decizia lui Costin pe cele două puncte, apoi o cale care le respectă. Se închide când o firmă adăugată din greșeală se poate scoate, iar una cu evidență **nu** se poate — cu gard pe amândouă direcțiile.

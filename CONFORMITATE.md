...
- **condiția de deblocare**: decizia de mai sus, apoi cablarea ei într-un singur loc prin care trec toate cele 12 câmpuri. Se închide când `core/test_cont_din_corp_normalizat.py` cere, pe lângă `strip()`, și confruntarea cu planul.

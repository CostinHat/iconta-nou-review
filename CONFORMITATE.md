...
- **măsurat la**: 2026-08-30 · **pe commit**: `d54d58a`
...
|---|---|
| **cele 9 declarații** | **0 din 92 de ieșiri își arată componentele.** Ruta întoarce un CONTOR de operațiuni, nu operațiunile. Iar cele 92 de `temei` sunt ale **validatorului**, nu ale cifrei. *Aici nici ruta nu trimite — deci e mai scump decât cele două de mai jos.* |
...
| **netul de pe fluturaș** | ruta trimite componentele, ecranul nu randează **niciuna** — cuvintele apar în JS doar ca etichete pe formulare de introducere. **Adâncimea, măsurată la R97: 12 câmpuri tăcute**, nu 7 cât se știa; printre cele noi `cm_brut`/`cm_net`/`cm_zile` (**concediul medical**) și tichetele. Componentele se văd **numai în PDF-ul descărcat** |
| **Registrul-jurnal** (14-1-1) | **venit din lista 3**: ruta derivă `nr_curent`, `document` și `total_debit`/`total_credit` — cele trei elemente cerute de OMFP 2634 Anexa 1 pct. 45 — iar ecranul nu afișează **niciunul**. **Adâncimea, măsurată la R97: 2 câmpuri tăcute sigur** plus 2 candidate |

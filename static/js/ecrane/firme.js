...
import { api, dataRo, arataMesaj, confirmaCaseta, deschideLupa, bani, esc, CULORI_CARD, pct, eroareCamp, curataEroriCamp, semnAjutor } from "../api.js?v=3857bab660";  /* msg_conventie_fe_v1 + generalizare_zi_v1 */
...
import { meniuMigrarePerFirma, randeazaMigrare } from "./migrare.js?v=dfc006b871";  // [p96_import_firma] + [Q4] import in masa

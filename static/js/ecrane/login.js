...
const GRUPE_FUNC = [{"titlu": "Contabilitate", "icon": "brief", "functii": ["Avansuri furnizori/clienti", "Bacsis HoReCa", "Bilant anual S1005/S1003", "Blocare perioade", "Centre de cost + bugete (management accounting intern)", "Contabilitate ONG", "Decontari asociati", "Deconturi deplasare si diurna", "Editor note contabile", "Incredere si invatare AI", "Leasing financiar si operational", "Lichidare/radiere societate", "Motor contabil (carte mare + inchidere)", "Perisabilitati si scazaminte", "Productie in curs si produse finite", "Provizioane si ajustari", "Rapoarte comerciale", "Rapoarte configurabile salvabile", "Reevaluare imobilizari", "Registru incasari/plati (partida simpla)", "SGR (garantie-returnare)", "Sponsorizari si credit fiscal", "Subventii"]}, {"titlu": "Fiscalitate", "icon": "declaratii", "functii": ["Coada de validare patru-ochi", "Curs valutar BNR", "Declaratia D100", "Declaratia D101 + IMCA", "Declaratia D101G (impozit pe profit - grup fiscal)", "Declaratia D104 (distribuire venituri asocieri)", "Declaratia D106 (informativa dividende actionari de stat)", "Declaratia D107 (beneficiari sponsorizari/mecenat/burse)", "Declaratia D108 (impozit pe reprezentanta)", "Declaratia D110 (regularizare impozit retinut la sursa)", "Declaratia D112", "Declaratia D114 (contributia asiguratorie pentru munca - CAM)", "Declaratia D119 (declaratie speciala BNR - obligatii buget)", "Declaratia D120 (decont accize)", "Declaratia D130 (decont impozit la titeiul din productia interna)", "Declaratia D169 (inregistrare contracte de fiducie)", "Declaratia D169n (neconcordante beneficiar real fiducie)", "Declaratia D177 (redirectionare impozit profit)", "Declaratia D200 (venituri realizate din Romania - persoane fizice)", "Declaratia D201 (venituri realizate din strainatate - persoane fizice)", "Declaratia D204 (asocieri fara personalitate juridica)", "Declaratia D205 + distribuire dividende", "Declaratia D207 (impozit retinut nerezidenti)", "Declaratia D208 (transfer proprietati imobiliare - notari)", "Declaratia D212 (declaratia unica)", "Declaratia D214 (instrainare teren agricol extravilan prin hotarare judecatoreasca)", "Declaratia D216 (impozit special pe bunuri de valoare mare)", "Declaratia D220 (venit estimat / norma de venit)", "Declaratia D221 (venituri agricole pe norme de venit)", "Declaratia D223 (venituri estimate asocieri)", "Declaratia D230 (redirectionare 3,5%)", "Declaratia D300", "Declaratia D301", "Declaratia D307 (ajustare TVA)", "Declaratia D311 (TVA cod anulat)", "Declaratia D318 (rambursare TVA din alt stat membru UE)", "Declaratia D390 (VIES)", "Declaratia D393 (bilete transport rutier international de persoane)", "Declaratia D394", "Declaratia D395 (trimiteri postale contra ramburs)", "Declaratia D397 (transport alternativ cu autoturism si conducator auto)", "Declaratia D398 (TVA regim special OSS - UE/non-UE)", "Declaratia D399 (TVA regim special import - IOSS)", "Declaratia D401 (proprietati imobiliare ale nerezidentilor - DAC)", "Declaratia D403 (asigurari de viata - schimb automat DAC2/CRS)", "Declaratia D406 (SAF-T)", "Declaratia D407 (institutii financiare raportoare)", "Declaratia D600 (baza CAS/CASS estimata - persoane fizice)", "Declaratia D603 (exceptare de la plata CASS)", "Declaratia D710 (rectificativa D100)", "Diferente de curs valutar", "Dispatch declaratii", "Import/export extracomunitar", "Motor D212 (PFA/II/IF)", "Persistarea declaratiei depuse (xml + randuri) - F163v2", "Regim special agentii de turism", "Regim special agricultori", "Regim special aur de investitii", "Regim special marja (second-hand)", "Regula cotelor de TVA", "TVA la incasare", "Taxare inversa interna", "Trimitere D390 clasificari manuale"]}, {"titlu": "Control fiscal", "icon": "shield", "functii": ["Audit de preluare firma", "Avertisment regim TVA vs ANAF + semafor Control fiscal", "Calculul scadentelor", "Conformitate cota TVA facturi emise (punte legislatie->re-verificare v1)", "Control incrucisat: D112 (salarii) vs contabilitate", "Control incrucisat: D390 (bunuri IC) vs evidenta validata + D300 depus (D-vs-D real F198)", "Control incrucisat: declaratie vs contabilitate (TVA)", "Declaratia D213 (instrainare pachet control - terenuri agricole extravilan)", "Educatie AI pe tipare (varianta generativa)", "Educatie pe tipare de erori", "Push in-app findinguri rosii control fiscal (pull->push)", "Semafor conformare fiscala", "Vector fiscal per firma", "Verificatoare de coerenta", "Verificator praguri Intrastat"]}, {"titlu": "Facturare si e-Factura", "icon": "facturi", "functii": ["Chitante emise", "Comodat, chirii, refacturari", "Conector OAuth SPV/ANAF", "Conector WooCommerce", "Cont venit implicit setabil din UI", "Contare facturi + TVA + storno", "Export facturi emise catre SAGA", "Export facturi emise catre WinMENTOR", "Facturi recurente", "Import e-Factura (UBL)", "Link de plata pe factura", "Nomenclator produse + cota AI", "Notificare e-Transport", "Notificari de plata si alerte neplatnici", "Operatiuni intracomunitare", "PDF factura", "Parteneri (clienti/furnizori)", "Profil firma + model factura", "Trimitere e-Transport prin API SPV", "Validare CUI la ANAF", "e-Factura SPV complet"]}, {"titlu": "Salarizare", "icon": "users", "functii": ["Adeverinte salariati", "Calcul salarizare (brut->net)", "Client REGES-ONLINE", "Cod 10 CM in flux", "Coduri COR pe contracte", "Contracte de munca speciale", "Declaratia D402 (venituri salariale ale nerezidentilor - DAC1)", "Plata salariilor pe card (fisier bancar)", "Pontaj angajati", "Salariati (CRUD)", "Stat de plata + fluturasi", "Tichete de masa + vacanta + cadou in stat plata (Faza 1 + 2a + 2b1)"]}, {"titlu": "Stocuri, banca si casa", "icon": "building", "functii": ["Analitica de stoc", "Coduri de bare in gestiune", "Contabilizare extras de cont", "Credite bancare si garantii", "Import Raport Z din AMEF", "Import articole si stoc initial CV", "Import extras bancar MT940 (SWIFT)", "Inventar pe mobil", "Inventariere anuala", "Landed cost pe NIR", "Obiecte de inventar", "Parser extras bancar", "Punte factura -> stoc (descarcare la emitere)", "Reconciliere bancara (matching)", "Registru de casa + plafoane", "Retetar HoReCa (GV)", "Stocuri cantitativ-valorice (CMP)", "Stocuri global-valorice", "Transfer intre gestiuni"]}, {"titlu": "Cabinet si portal client", "icon": "documente", "functii": ["API portal (read-only, izolat)", "API public v1", "Alerte legislative programate", "Autoservire export date cabinet (buton)", "Canal de sesizari (Raporteaza)", "Cerere de stergere cont din aplicatie (GDPR art.17)", "Chei API publice per cabinet", "Documente pentru portal", "Export GDPR complet cabinet (portabilitate)", "Forecast cash-flow 8 saptamani", "Generare contracte", "Import la preluarea firmei", "Inregistrare cabinet self-service", "KPI client (portal)", "Magic-link (login fara parola)", "Management actori de cabinet", "Notificari in-app + email", "Notificari pe evenimente", "PWA (aplicatie instalabila)", "Panou Capacitate", "Povestea lunii (pachet lunar)", "Pre-completare date firma din ANAF v9 la onboarding", "Previzualizare portal client din cabinet (Acces Client)", "Registratura documente", "Scadente viitoare pe portofoliu", "Sinteza zilnica pe email", "Starea migrarii pe straturi", "Suspendare cabinet", "Triaj AI al sesizarilor"]}];
// </GRUPE_FUNC_AUTO>

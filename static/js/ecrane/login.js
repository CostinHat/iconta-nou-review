...
// <DECLARATII_AUTO> generat de genereaza_declaratii_lista.py --scrie; NU edita manual intre ancore
const DECLARATII_50 = [{"tip": "D100", "per": "trimestrial", "ce_e": "Declarație privind obligațiile de plată la bugetul de stat"}, {"tip": "D101", "per": "anual", "ce_e": "Declarație privind impozitul pe profit"}, {"tip": "D101G", "per": "anual", "ce_e": "Declarație CONSOLIDATĂ privind impozitul pe profit determinat de GRUPUL FISCAL"}, {"tip": "D104", "per": "trimestrial", "ce_e": "Declarație privind distribuirea între asociați a veniturilor și cheltuielilor"}, {"tip": "D106", "per": "anual", "ce_e": "Declarație informativă privind dividendele cuvenite acționarilor"}, {"tip": "D107", "per": "anual", "ce_e": "Declarație informativă privind beneficiarii sponsorizărilor / mecenatului / burselor private"}, {"tip": "D108", "per": "anual", "ce_e": "Declarație privind impozitul pe reprezentanță"}, {"tip": "D110", "per": "lunar", "ce_e": "Declarație de regularizare / cerere de restituire privind impozitul pe venit reținut la sursă"}, {"tip": "D112", "per": "lunar", "ce_e": "Declarație privind obligațiile de plată a contribuțiilor sociale, impozitului pe venit și evidența nominală a persoanelor asigurate"}, {"tip": "D114", "per": "lunar", "ce_e": "Declarație privind obligațiile de plată a contribuției asiguratorii pentru muncă"}, {"tip": "D119", "per": "lunar", "ce_e": "Declarație specială privind obligațiile de plată la bugetul de stat"}, {"tip": "D120", "per": "anual", "ce_e": "Decont privind accizele"}, {"tip": "D130", "per": "anual", "ce_e": "Decont privind impozitul la țițeiul din producția internă"}, {"tip": "D169", "per": "anual", "ce_e": "Declarație de înregistrare a contractelor de fiducie sau a construcțiilor juridice similare fiduciei"}, {"tip": "D169N", "per": "anual", "ce_e": "Declarație privind neconcordanțele dintre informațiile privind beneficiarii reali"}, {"tip": "D177", "per": "anual", "ce_e": "Cerere privind redirecționarea impozitului pe profit către entități nonprofit"}, {"tip": "D200", "per": "anual", "ce_e": "Declarație privind veniturile realizate din România (persoane fizice)"}, {"tip": "D201", "per": "anual", "ce_e": "Declarație privind veniturile realizate din străinătate (persoane fizice)"}, {"tip": "D204", "per": "anual", "ce_e": "Declarație anuală de venit pentru asocieri fără personalitate juridică"}, {"tip": "D205", "per": "anual", "ce_e": "Declarație informativă privind impozitul reținut la sursă și câștigurile/pierderile din investiții, pe beneficiari de venit"}, {"tip": "D207", "per": "anual", "ce_e": "Declarație informativă privind impozitul reținut la sursă pe beneficiari nerezidenți"}, {"tip": "D208", "per": "semestrial", "ce_e": "Declarație informativă privind impozitul pe veniturile din transferul proprietăților imobiliare din patrimoniul personal"}, {"tip": "D212", "per": "anual", "ce_e": "Declarația unică privind impozitul pe venit și contribuțiile sociale datorate de persoanele fizice"}, {"tip": "D213", "per": "anual", "ce_e": "Declarație privind veniturile realizate de persoana fizică și/sau asocierea fără personalitate juridică"}, {"tip": "D214", "per": "anual", "ce_e": "Cerere pentru stabilirea impozitului pe venitul din înstrăinarea de terenuri agricole"}, {"tip": "D216", "per": "anual", "ce_e": "Declarație privind impozitul special pe bunurile imobile și mobile de valoare mare"}, {"tip": "D220", "per": "anual", "ce_e": "Declarație privind venitul estimat / norma de venit (persoane fizice)"}, {"tip": "D221", "per": "anual", "ce_e": "Declarație privind veniturile din activități agricole impuse pe bază de norme de venit"}, {"tip": "D223", "per": "anual", "ce_e": "Declarație privind veniturile estimate pentru asocierile fără personalitate juridică"}, {"tip": "D230", "per": "anual", "ce_e": "Cerere privind destinația sumei de până la 3,5% din impozitul anual (redirecționare ONG)"}, {"tip": "D300", "per": "lunar", "ce_e": "Decont de TVA"}, {"tip": "D301", "per": "lunar", "ce_e": "Decont special de TVA"}, {"tip": "D307", "per": "lunar", "ce_e": "Declarație privind sumele rezultate din ajustarea/corecția ajustărilor/regularizarea TVA"}, {"tip": "D311", "per": "lunar", "ce_e": "TVA datorată de persoane impozabile al căror cod de TVA a fost anulat"}, {"tip": "D318", "per": "anual", "ce_e": "Cerere de rambursare a TVA pentru persoane impozabile stabilite în România, depusă în alt stat membru"}, {"tip": "D390", "per": "lunar", "ce_e": "Declarație recapitulativă VIES privind livrările/achizițiile/prestările intracomunitare"}, {"tip": "D393", "per": "anual", "ce_e": "Declarație informativă privind biletele de călătorie pentru transportul rutier de persoane"}, {"tip": "D394", "per": "lunar", "ce_e": "Declarație informativă privind livrările/prestările și achizițiile efectuate pe teritoriul național"}, {"tip": "D395", "per": "lunar", "ce_e": "Declarație informativă privind trimiterile poștale contra ramburs"}, {"tip": "D397", "per": "lunar", "ce_e": "Declarație informativă privind activitățile de transport alternativ cu autoturism și conducător auto"}, {"tip": "D398", "per": "trimestrial", "ce_e": "Declarație specială de TVA pentru regimurile speciale UE / non-UE / import (OSS)"}, {"tip": "D399", "per": "trimestrial", "ce_e": "Declarație specială de TVA pentru regimul special de import (IOSS)"}, {"tip": "D401", "per": "anual", "ce_e": "Declarație informativă privind proprietățile imobiliare deținute de rezidenți ai altor state membre UE"}, {"tip": "D402", "per": "anual", "ce_e": "Declarație informativă privind veniturile de natură salarială plătite de intermediari"}, {"tip": "D403", "per": "anual", "ce_e": "Declarație informativă privind produsele de asigurare de viață contractate de rezidenți ai altor state membre UE"}, {"tip": "D406", "per": "lunar", "ce_e": "Fișierul Standard de Control Fiscal (SAF-T) pentru România"}, {"tip": "D407", "per": "semestrial", "ce_e": "Declarație informativă privind persoanele și sumele/produsele declarate de intermediari"}, {"tip": "D600", "per": "anual", "ce_e": "Declarație privind venitul asupra căruia se datorează contribuția de asigurări sociale de sănătate"}, {"tip": "D603", "per": "anual", "ce_e": "Declarație pe propria răspundere pentru exceptarea de la plata contribuției de asigurări sociale de sănătate"}, {"tip": "D710", "per": "trimestrial", "ce_e": "Declarație rectificativă"}];
// </DECLARATII_AUTO>
// <GRUPE_FUNC_AUTO> generat de genereaza_grupe_functii.py --scrie; NU edita manual intre ancore (gardat de GRUPE_FUNC_STALE)
const GRUPE_FUNC = [{"titlu": "Contabilitate", "icon": "brief", "functii": ["Avansuri furnizori/clienți", "Bacșiș HoReCa", "Bilanț anual S1005/S1003", "Blocare perioade", "Centre de cost + bugete (management accounting intern)", "Contabilitate ONG", "Deconturi deplasare și diurnă", "Decontări asociați", "Editor note contabile", "Leasing financiar și operațional", "Lichidare/radiere societate", "Mijloace fixe (registru active)", "Motor contabil (carte mare + închidere)", "Perisabilități și scăzăminte", "Producție în curs și produse finite", "Provizioane și ajustări", "Rapoarte comerciale", "Rapoarte configurabile salvabile", "Reevaluare imobilizări", "Registru încasări/plăți (partidă simplă)", "SGR (garanție-returnare)", "Sponsorizări și credit fiscal", "Subvenții", "Încredere și învățare AI"]}, {"titlu": "Fiscalitate", "icon": "declaratii", "functii": ["Coada de validare patru-ochi", "Curs valutar BNR", "Declarația D100", "Declarația D101 + IMCA", "Declarația D104 (distribuire venituri asocieri)", "Declarația D107 (beneficiari sponsorizări/mecenat/burse)", "Declarația D110 (regularizare impozit reținut la sursă)", "Declarația D112", "Declarația D114 (contribuția asiguratorie pentru muncă - CAM)", "Declarația D177 (redirecționare impozit profit)", "Declarația D200 (venituri realizate din România - persoane fizice)", "Declarația D201 (venituri realizate din străinătate - persoane fizice)", "Declarația D204 (asocieri fără personalitate juridică)", "Declarația D205 + distribuire dividende", "Declarația D207 (impozit reținut nerezidenți)", "Declarația D208 (transfer proprietăți imobiliare - notari)", "Declarația D212 (declarația unică)", "Declarația D216 (impozit special pe bunuri de valoare mare)", "Declarația D221 (venituri agricole pe norme de venit)", "Declarația D223 (venituri estimate asocieri)", "Declarația D230 (redirecționare 3,5%)", "Declarația D300", "Declarația D301", "Declarația D307 (ajustare TVA)", "Declarația D311 (TVA cod anulat)", "Declarația D318 (rambursare TVA din alt stat membru UE)", "Declarația D390 (VIES)", "Declarația D394", "Declarația D398 (TVA regim special OSS - UE/non-UE)", "Declarația D406 (SAF-T)", "Declarația D600 (baza CAS/CASS estimată - persoane fizice)", "Declarația D603 (exceptare de la plata CASS)", "Declarația D710 (rectificativă D100)", "Diferențe de curs valutar", "Dispatch declarații", "Import/export extracomunitar", "Motor D212 (PFA/II/IF)", "Persistarea declarației depuse (xml + rânduri) - F163v2", "Regim special agenții de turism", "Regim special agricultori", "Regim special aur de investiții", "Regim special marja (second-hand)", "Regula cotelor de TVA", "Rând manual D300", "TVA la încasare", "Taxare inversă internă", "Trimitere D390 clasificări manuale"]}, {"titlu": "Control fiscal", "icon": "shield", "functii": ["Audit de preluare firma", "Avertisment regim TVA vs ANAF + semafor Control fiscal", "Calculul scadențelor", "Conformitate cota TVA facturi emise (punte legislație->re-verificare v1)", "Control încrucișat: D112 (salarii) vs contabilitate", "Control încrucișat: D390 (bunuri IC) vs evidența validată + D300 depus (D-vs-D real F198)", "Control încrucișat: declarație vs contabilitate (TVA)", "Educație AI pe tipare (variantă generativă)", "Educație pe tipare de erori", "Push în-app findinguri roșii control fiscal (pull->push)", "Semafor conformare fiscală", "Vector fiscal per firmă", "Verificatoare de coerență", "Verificator praguri Intrastat"]}, {"titlu": "Facturare si e-Factura", "icon": "facturi", "functii": ["Chitanțe emise", "Clasificare TVA pe factură", "Comodat, chirii, refacturări", "Conector OAuth SPV/ANAF", "Conector WooCommerce", "Cont venit implicit setabil din UI", "Contare facturi + TVA + storno", "Export facturi emise către SAGA", "Export facturi emise către WinMENTOR", "Facturi recurente", "Import e-Factura (UBL)", "Link de plată pe factura", "Nomenclator produse + cota AI", "Notificare e-Transport", "Notificări de plată și alerte neplătnici", "Operațiuni intracomunitare", "PDF factură", "Parteneri (clienți/furnizori)", "Profil firmă + model factură", "Trimitere e-Transport prin API SPV", "Validare CUI la ANAF", "e-Factura SPV complet"]}, {"titlu": "Salarizare", "icon": "users", "functii": ["Adeverințe salariați", "Calcul salarizare (brut->net)", "Client REGES-ONLINE", "Cod 10 CM în flux", "Coduri COR pe contracte", "Contracte de muncă speciale", "Plata salariilor pe card (fișier bancar)", "Pontaj angajați", "Salariați (CRUD)", "Stat de plată + fluturași", "Tichete de masă + vacanță + cadou în stat plata (Faza 1 + 2a + 2b1)"]}, {"titlu": "Stocuri, banca si casa", "icon": "building", "functii": ["Analitică de stoc", "Coduri de bare în gestiune", "Contabilizare extras de cont", "Credite bancare și garanții", "Import Raport Z din AMEF", "Import articole și stoc initial CV", "Import extras bancar MT940 (SWIFT)", "Inventar pe mobil", "Inventariere anuală", "Landed cost pe NIR", "Obiecte de inventar", "Parser extras bancar", "Punte factura -> stoc (descărcare la emitere)", "Reconciliere bancară (matching)", "Registru de casă + plafoane", "Rețetar HoReCa (GV)", "Stocuri cantitativ-valorice (CMP)", "Stocuri global-valorice", "Transfer între gestiuni"]}, {"titlu": "Cabinet si portal client", "icon": "documente", "functii": ["API portal (read-only, izolat)", "API public v1", "Alerte legislative programate", "Autoservire export date cabinet (buton)", "Canal de sesizări (Raportează)", "Cerere de ștergere cont din aplicație (GDPR art.17)", "Chei API publice per cabinet", "Documente pentru portal", "Export GDPR complet cabinet (portabilitate)", "Forecast cash-flow 8 săptămâni", "Generare contracte", "Import la preluarea firmei", "KPI client (portal)", "Magic-link (login fără parolă)", "Management actori de cabinet", "Notificări pe evenimente", "Notificări în-app + email", "PWA (aplicație instalabilă)", "Panou Capacitate", "Povestea lunii (pachet lunar)", "Pre-completare date firmă din ANAF v9 la onboarding", "Previzualizare portal client din cabinet (Acces Client)", "Registratură documente", "Scadențe viitoare pe portofoliu", "Sinteza zilnică pe email", "Starea migrării pe straturi", "Suspendare cabinet", "Triaj AI al sesizărilor", "Înregistrare cabinet self-service"]}];
// </GRUPE_FUNC_AUTO>
...
function deschideDeclaratii() {
  evPublic("modal_declaratii");
  const celule = DECLARATII_50.map((d) =>
    `<li class="decl-chip"><span class="decl-cod">${esc(d.tip)}</span>` +
    `<button class="ajutor-btn decl-ce" type="button" data-tip="${esc(d.tip)}" ` +
    `aria-label="Ce este ${esc(d.tip)}">?</button></li>`).join("");
  const o = _funcOverlay(
    `<div class="fereastra fer-larg"><div class="fereastra-antet">` +
    `<span class="fereastra-titlu">Toate cele ${DECLARATII_50.length} de declarații</span>` +
    `<button class="nav-x" type="button" title="Închide" aria-label="Închide">✕</button></div>` +
    `<div class="fereastra-corp">` +
    `<ul class="decl-grila">${celule}</ul>` +
    `<div class="decl-explicatie" aria-live="polite">` +
    `Apasă <b>?</b> lângă o declarație ca să vezi ce este.</div>` +
    `</div></div>`
  );
  const zona = o.querySelector(".decl-explicatie");
  o.querySelectorAll(".decl-ce").forEach((b) => b.addEventListener("click", () => {
    const d = DECLARATII_50.find((x) => x.tip === b.dataset.tip);
    if (!d) return;
    o.querySelectorAll(".decl-chip").forEach((c) => c.classList.remove("decl-chip-activ"));
    b.closest(".decl-chip").classList.add("decl-chip-activ");
    zona.innerHTML = `<b>${esc(d.tip)}</b> — ${esc(d.ce_e)} <span class="decl-per">(${esc(d.per)})</span>`;
  }));
}
...
function deschideFunctionalitati() {
  ...
  // [decl50_v1] cardul „Toate declarațiile" — scris de mana, in afara zonei auto GRUPE_FUNC.
  // Numarul NU e scris aici: vine din lista derivata, ca sa nu poata ramane in urma.
  const cardDecl =
    `<button class="func-card func-card-decl" type="button" data-decl="1"><span class="func-card-icon">${svgIcon(ICOANE.declaratii, 26)}</span>` +
    `<span class="func-card-titlu">Toate declarațiile</span><span class="func-card-nr">${DECLARATII_50.length} tipuri</span></button>`;
  const carduri = cardPreturi + cardDecl + GRUPE_FUNC.map((gr, i) =>
  ...
  o.querySelector(".func-card-decl").addEventListener("click", deschideDeclaratii);

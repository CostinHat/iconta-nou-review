  ...
  function randeazaDesktop() {
    ...
    if (areBaraJos) {
      ...
      if (u.rol === "superadmin") {
        ...
        import("./api.js?v=5b2978a5b9").then(({ api }) => api.get("/admin/activitate/cabinete")).then((r) => {
    ...
    if (u.rol === "angajat") {
      ...
      import("./api.js?v=5b2978a5b9").then(({ api }) => api.get("/eu/calitate")).then((cal) => {
...
async function _clopotActualizeazaBadge(container) {  // [p66_badge_ref]
  ...
  try {
    const { api } = await import("./api.js?v=5b2978a5b9");

...
- ultim: Cluster 2 GATA — seed profil COMPLET (bancă/IBAN/declarant → D300 generabilă); P1 LUNAR D300+D394 lunile 2-6 TOATE DUK-VALIDE (coerența R3 curge prin generatoare). BUG CONFIRMAT (nereparat): perioada TVA TRIMESTRIALĂ neimplementată (M2/P2) — D300/D394 sub-raportează trimestrul (probă: P2 Q2 luna=6 omite T-2 din aprilie, DUK-valid dar R22=0), tip_d394 hardcodat 'L'. Vezi GARZI+DECIZII 06.08.
- urmator: Cluster 3 — FIX perioada trimestrială D300/D394/D390 (recomandare opțiunea B, DECIZII 06.08: decuplează luna-etichetă 3/6/9/12 de fereastra de date=trimestru; citește tip_decont; gard + RED/GREEN + DUK; vânătoare clasă pe D390). CONFIRMĂ design cu Costin întâi. Apoi restul TVA: D390 P1 (IC extern), D301 N1 (d301_operatiuni), marjă S1/S2, limite L1/L2/L3/L4/L10/L12.
- pasi:
  ...
  STARE = OPRIT §2.3 pct.6 (buget context) + decizie design API perioadă (DECIZII 06.08). Cluster 1+2 comise, verzi. Cluster 3 = fix trimestrial (RED test = primul pas).

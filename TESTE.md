...
| rutare D300 (IC/export/avans/furnizor/rand manual) | d300 | test_d300_b1_rutare.py | √ 15.08 (c8d3947 - fisier nou intrat in git la c8d3947 = HEAD; ancoreaza comportamentele B1-B4: achizitie IC -> R5 + oglinda R18 nu R26, livrare IC -> R1, export non-UE -> R14, RO/zero nu autoclasifica, anti-dubla-numarare la rand manual peste IC, fereastra avans pe emitere, deducere amanata furnizor cu TVA la incasare, paritate preview<->depunere pe randul manual persistat) | FISCAL | OPANAF 174/2026 (structura D300 v12); Legea 141/2025 (cote); CF art.282 (exigibilitate - avans/TVA la incasare), art.294 (scutiri export/livrari IC) | test_livrare_ic_bunuri_ruteaza_R1 test_achizitie_ic_bunuri_R5_oglinda_R18 test_export_non_ue_ruteaza_R14 test_discriminare_pe_tara_RO_zero_nu_autoclasifica test_antidubla_numarare_ic_livrare_manual_ridica test_avans_fereastra_pe_emitere_nu_reapare test_deducere_amanata_furnizor_la_incasare test_persistenta_manual_paritate_preview_depunere |

...
| tichete masa/vacanta | salarizare | test_salarizare.py | PARTIAL 31.07 — fond verificat (45/Legea 201/2025, imp10+CASS10 fara CAS, plafon 6sm, cadou 300); D2 nr tichete = DECIZIE DE PRODUS (pontaj autoritativ, xfail ramane); #3 baza CASS = GRI (fond prin derivare art.157->78, verbatim neconfirmabil portal); D2 nr tichete = CALCUL LIVRAT (fe99cc2: scad CO/delegatie/absente/invoire din pontaj, fara regresie; blocajul-daca-necompletat = decizie de scop, cere semnal de confirmare a lunii). D3 exces vacanta = nucleu OK (a7da09d) DAR PROBA DUK RESPINGE cablarea: exces in baza_contrib -> S74d 'B4_8(2675) mai mare de suma calculata (1250)' - DUK recalc B4 din GROSS-ul declarat (S731), care NU include excesul. Cablare REVERTATA. RAMAS: excesul trebuie sa intre in gross-ul declarat in D112 (S731/build_xml d112), nu doar in baza de contributii. OPRIRE la DUK (lectia 31.07). Cluster STA co-locat cu grupul salarizare. | FISCAL | Legea 201/2025; HG 1045/2018 art.10(3); CF art.76(3)h/78/142(r)/157(2); OUG 8/2009 art.1; L296/2023 |  |

...
- ultim: TRANȘA 2 ÎNCHISĂ (06.08 tura 2). Livrat: (e) T-5 forfetar orfan D300 (commit d1a2e4d); (b) D390 P1 achiziție IC de la furnizor UE + (c) D301 N1 din d301_operatiuni = ACOPERIRE (core/test_d390_d301_acoperire.py 4/4, DUK-valid + seed extins idempotent seed_ic_extern/seed_d301). Decizii Costin consemnate GARZI 06.08 tura 2: (d) marjă art.311/312 = gol de acoperire / decizie produs (nu se integrează acum; S1/S2 rămân pt restul obligațiilor); (f) L1/L2/L3/L10 = gol consolidat 'praguri fiscale declarate manual, neverificate de aplicație' (prag±1 = C-5, nu C-4), L4 rămâne C-4 (enforced+testat).
- urmator: TRANȘA 2 ÎNCHISĂ. Reziduu = DECIZII DE PRODUS (nu blochează nimic; pt tranșă viitoare cu greenlight Costin): (1) integrare regimuri pe marjă art.311/312 în D300 (model nou — flag/tabel operațiune pe marjă + rutare calcul_d300 pe rândurile de marjă); (2) enforcement praguri fiscale L1/L2/L3/L10 (derivare automată a statutului regim/perioadă/plătitor/obligație din CA/volume). Ambele = GARZI 06.08 tura 2 (2 goluri declarate).
- pasi:

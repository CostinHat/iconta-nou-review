...
- urmator: continuare tranșa 2: (a) BUG D300 FURNIZOR taxare inversă (d300.pull nu citește taxare_inversa → livrarea art.331 nu ajunge în R13; P2 Q3 D300 gol); (b) D390 P1 (IC extern); (c) D301 N1 (d301_operatiuni); (d) D300 marjă S1/S2 art.311/312; (e) T-5 forfetar agricol; (f) limite TVA L1/L2/L3/L4/L10/L12 ×3.
- pasi:
  ...
  STARE = IN LUCRU. Cluster 1+2+3 + T-6 categorie comise, verzi. Trim fix (5/5 condiții) + T-6 D394 valide. Descoperit bug D300 furnizor taxare inversă (nereparat). Oprire §2.3 pct.6 (buget) — următor: (a) D300 furnizor taxare inversă.

...
- ultim: Cluster 3 GATA — FIX trimestrial (optiunea B) COMIS: common.perioada_tva_tip (vector fiscal, eroare la lipsă) + fereastra_tva (decuplează eticheta luna de fereastră) în d300/d394/pull + reconciliere ×2; D390 confirmat lunar (neatins). P2 Q2 include acum aprilie (R22_2 0→16800) DUK-valid; tip_D394 'T'; P1 10/10 fără regresie. Gard test_d300_d394_trimestrial.py + mutație probată. 23 fixturi reparate.
- urmator [PREDARE tranșa 2 — următoarea sesiune]: (b) D390 P1 (IC de la furnizor UE extern — neseed-uit); (c) D301 N1 (tabelul d301_operatiuni, NU facturi); (d) D300 marjă S1/S2 art.311/312 (operațiuni pe marjă neseed-uite); (e) T-5 forfetar agricol (deductibilitate forfait la P1); (f) limite TVA L1/L2/L3/L4/L10/L12 ×3 cazuri. Infrastructură: seed transa2_coerenta_tva.py (11 firme + T-1…T-7), fix trimestrial + rd.13 furnizor DONE.
- pasi:
  ...
  STARE = OPRIT §2.3 pct.6 (buget context) la graniță curată. Livrate verzi: seed 11 firme + T-1…T-7; fix trimestrial D300/D394 (5/5 condiții); T-6 taxare inversă (D394 + D300 furnizor rd.13 auto). PREDARE: D390/D301/marjă/T-5/limite (vezi urmator).

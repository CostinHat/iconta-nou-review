...
- fir: sponsorizari cluster "credit sponsorizare / D177" — profit CONFORM (gard existent) + datorie micro period-aware + D177 decizie produs (lant)
- ultim: plafon diurna|deconturi calcul curent conform + datorie (3a058a4).
- urmator: cluster inchis (profit conform + micro datorie + D177 decizie produs). Ruleaza urmator_cluster(). GATA.
- pasi:
  SP1. [verificare + datorie] Creditul de sponsorizare PROFIT (sponsorizari.py min(0,75% CA; 20% impozit) + conditia registru) = CONFORM CF art.25 alin.(4) lit.i (verificat la sursa); reportul pe 7 ani corect eliminat (2022). Gardat de test_operatiuni_speciale.py (4 teste). NECONFORMITATE #1 MICRO: _credit_sponsorizare_2018 intoarce credit=0 pt micro la ORICE data >=2018, desi micro avea creditul (20% impozit micro) pana in 2023 (fostul art.56 alin.1^5, abrogat OUG 115/2023 din 2024). Aplica retroactiv eliminarea 2024 - contrazice propriul docstring. Fix BLOCAT: rata+start micro nu-s in consolidat (alin.1^5 = "Abrogat"); §3 nu se inventeaza. -> DATORIE xfail strict. #2 D177: formular ABSENT (doar scalar redirectionabil) = DECIZIE DE PRODUS (construire formular Ordin ANAF 3562/2024). #3 endpoint main.py:7853 apeleaza credit_sponsorizare fara la_data (neperiodizat) - observatie. Commit.
  STARE = GATA (SP1 comis)
...
1. rezerva legala | motor
2. zilieri (impozit+CAS) | contracte_speciale
3. regim marja second-hand | tva_marja
4. regim marja turism | tva_marja_turism
5. impozit dividend | decontari_asociati
6. contributii PFA (praguri CAS/CASS pe sm) | d212
7. nomenclator cod_oblig<->cod_bugetar | d100
8. cota micro 121 (flag) | d100
9. checksum totalPlata_A (R11b) | d100
10. scadente/nr_evidenta | d100
11. structura P1-P53 | d101
12. R17 Data_S / termen | d101
13. limita text 75 | d112
14. nomenclator cod_oblig | d112
15. checksum totalPlata_A | d205
16. trunchiere den/adresa | d205
17. randuri / checksum | d300
18. checksum totalPlata_A (R28) | d301
19. nomenclator tari (HR->CR) | d390
20. tipuri operatiune (pct.215) | d394
21. tip_partener | d394
22. rezumat1 campuri complete | d394
23. nomenclator codPR (art.331) | d394
24. totalPlata_A (R17) | d394
25. plan conturi pe norma | d406
26. UoM UN/ECE | d406
27. MovementType nomenclator | d406
28. BaseRate (encoding pro-rata) | d406
29. registration_number (00+CUI) | d406
30. structura XSD (Header/MasterFiles/GLE) | d406
31. structura declaratie710 | d710
32. nomenclator COD_BUGETAR | d710
33. checksum R11b | d710
34. R15 termen definitivare | d710
35. scadente | d710

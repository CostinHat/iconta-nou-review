...
|---|---|---|
| suita pytest (1317 teste, 133 fișiere) | logică, schemă, semnături, contracte | la dev, înainte de commit |
...
**Stare: PARȚIAL.**
- ACOPERIT de fapt: 1317 teste colectate; fake-uri (`monkeypatch`/`MagicMock`) doar pe

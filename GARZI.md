...
|---|---|---|
| suita pytest (1306 teste, 133 fișiere) | logică, schemă, semnături, contracte | la dev, înainte de commit |
...
**Stare: PARȚIAL.**
- ACOPERIT de fapt: 1306 teste colectate; fake-uri (`monkeypatch`/`MagicMock`) doar pe

# -*- coding: utf-8 -*-
"""SESIUNEA B — F2 ETAPA 5 (Contabilizare): valideaza notele ciorna din jurnal. Vezi asteptari_f2_etapa5.md.
Rulare: ./venv/bin/python frontend_test/proba_f2_etapa5.py
"""
import os
import sys
...
def main():
    with sync_playwright() as pw:
        ...
        try:
            ...
            print("note ciorna de validat:", n0)
            for _ in range(20):
                b2 = pg.query_selector("[data-val]")
                if not b2: break
                b2.click(); pg.wait_for_timeout(1200)
            print("note ciorna ramase:", len(pg.query_selector_all("[data-val]")))
            H.shot(pg, "f2_e5_jurnal")
            print("erori consola:", erc[:4])
        except Exception as e:
            H.shot(pg, "f2_e5_EROARE"); print("EROARE:", str(e)[:300]); raise
        finally:
            b.close()
